...
print('left_i2iii\n' ,  repr(left_i2iii.shape))
print('left_iv   \n' ,  repr(left_iv.shape))
print('left_v    \n' ,  repr(left_v.shape))
print('left_vi   \n' ,  repr(left_vi.shape))
print('left_crusi\n' ,  repr(left_crusi.shape))
print('left_crusii\n',  repr(left_crusii.shape))
print('left_viib \n' ,  repr(left_viib.shape))
print('left_viiia\n' ,  repr(left_viiia.shape))
print('left_viiib\n' ,  repr(left_viiib.shape))
print('left_ix   \n' ,  repr(left_ix.shape))
print('left_x    \n' ,  repr(left_x.shape))

print('right_i2iii\n' ,repr(right_i2iii.shape))
print('right_iv   \n' ,repr(right_iv.shape))
print('right_v    \n' ,repr(right_v.shape))
print('right_vi   \n' ,repr(right_vi.shape))
print('right_crusi\n' ,repr(right_crusi.shape))
print('right_crusii\n',repr(right_crusii.shape))
print('right_viib \n' ,repr(right_viib.shape))
print('right_viiia\n' ,repr(right_viiia.shape))
print('right_viiib\n' ,repr(right_viiib.shape))
print('right_ix   \n' ,repr(right_ix.shape))
print('right_x    \n' ,repr(right_x.shape))

print('vermis_vi\n', repr(vermis_vi.shape))
print('vermis_vii\n', repr(vermis_vii.shape))
print('vermis_viii\n', repr(vermis_viii.shape))
print('vermis_ix\n', repr(vermis_ix.shape))
print('vermis_x\n', repr(vermis_x.shape))
