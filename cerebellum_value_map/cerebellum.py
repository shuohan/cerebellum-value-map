...
class VermisVI(CerebellarRegion):
    def __init__(self, coloring_value=0, disabling_value=-float('inf')):
        fs = FS(M((40.312, 90.5)),
                ...
                Q((22.055, 115.333), (11.394, 113.775)),
                Q((9.005, 107.830), (8.583, 104.400)),
                Q((7.976, 99.473), (10.259, 90.509)),
                Q((21.124, 90.500), (40.312,90.500)))
...
class VermisVII(CerebellarRegion):
    def __init__(self, coloring_value=0, disabling_value=-float('inf')):
        fs = FS(M((40.312, 115.333)),
                ...
                L((11.962, 181.333)),
                Q((9.322, 176.059), (8.923, 173.206)),
                Q((8.254, 168.411), (12.529, 160.306)),
                Q((9.920, 155.610), (9.605, 152.768)),
                Q((8.923, 146.637), (13.664, 136.473)),
                Q((9.470, 132.519), (8.923, 129.606)),
                Q((7.902, 124.156), (11.394, 113.775)),
                Q((22.055, 115.333), (40.312,115.333)))
        super().__init__(fs, anotation_text='',
                         anotation_position='right',
                         coloring_value=coloring_value,
                         disabling_value=disabling_value)
...
class VermisVIII(CerebellarRegion):
    def __init__(self, coloring_value=0, disabling_value=-float('inf')):
        fs = FS(M((40.312, 181.333)),
                ...
                Q((16.898, 209.923), (7.990, 207.973)),
                Q((6.986, 203.404), (7.519, 200.959)),
                Q((8.163, 198.006), (11.962, 193.786)),
                Q((10.060, 190.080), (9.945, 187.852)),
                Q((9.809, 185.209), (11.962, 180.735)))
        super().__init__(fs, anotation_text='',
                         anotation_position='right',
                         coloring_value=coloring_value,
                         disabling_value=disabling_value)
...
class VermisIX(CerebellarRegion):
    def __init__(self, coloring_value=0, disabling_value=-float('inf')):
        fs = FS(M((40.312, 208.667)),
                ...
                Q((25.105, 231.250), (11.394, 236.913)),
                Q((8.850, 231.783), (7.994, 228.808)),
                Q((5.942, 221.680), (7.990, 207.973)),
                Q((16.898, 209.923), (40.312, 208.667)))
        super().__init__(fs, anotation_text='',
                         anotation_position='right',
                         coloring_value=coloring_value,
                         disabling_value=disabling_value)
...
class VermisX(CerebellarRegion):
    def __init__(self, coloring_value=0, disabling_value=-float('inf')):
        fs = FS(M((40.312, 233.155)),
                ...
                C((36.560, 296.759), (27.355, 296.377), (22.744, 292.523)),
                C((17.218, 287.904), (14.594, 277.828), (13.454, 272.885)),
                C((11.426, 264.095), (10.925, 252.623), (11.394, 236.913)),
                C((20.535, 233.138), (30.174, 231.885), (40.312, 233.155)))
