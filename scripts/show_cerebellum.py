...
desc = 'Show values as colors on a cerebellum illustration.'
...
parser.add_argument('-o', '--output-svg', help='The output filename.')
...
parser.add_argument('-v', '--vmin', default=-2, dtype=float,
                    help='The value of the left-most color in a continuous '
                         'colormap.')
parser.add_argument('-V', '--vmax', default=2, dtype=float,
...
parser.add_argument('-n', '--region-names', default=None,
                    help='The names of regions to show. Use default if None.')
parser.add_argument('-s', '--size', dtype=int, nargs=2, default=(75, 73),
                    help='The size of the svg image.')
parser.add_argument('-t', '--translate', dtype=float, nargs=2,
                    default=(-84, -50),
                    help='The translation of the cerebellum in the SVG image. '
                         'The translation is performed before scaling.')
parser.add_argument('-s', '--scale', dtype=float, default=0.2,
                    help='The scale factor of the cerebellum in the SVG image. '
                         'The translation is performed before scaling.')
parser.add_argument('-f', '--font-size', dtype=int, default=9,
                    help='The font size in the SVG image.')
parser.add_argument('-S', '--stroke-width', dtype=int, default=2,
...
from cerebellum_value_map import CerebellumLabelColors, convert_pval
